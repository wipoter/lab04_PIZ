...
class MyForm extends React.Component{
    ...
    render() {
        return(
            <div>
                <Form action={"/Serv"} method={'get'} id={'MySubmit'} target={'_blank'} className="form" onSubmit={this.contactSubmit.bind(this)}>
                ...
                <a href={"https://www.chess.com/puzzles/problem/109540"} target={"_blank"}>Puzzle link </a>
